  ...
  const Models: ParticleModelProps[] = [
    {
      ...
      path: new URL('../legacy-three/models/examples/cube.fbx', import.meta.url)
        .href, // Use new URL() to get the correct path to the asset
      onLoadComplete(Geometry: BufferGeometry) {
        const s = 400;
        Geometry.scale(s, s, s);
      },
      loader: {
        loaderInstance: new FBXLoader(),
        load(group: { children: any }) {
    ...
    },
    {
      ...
      path: new URL('../legacy-three/models/examples/ball.obj', import.meta.url)
        .href, // Use new URL() to get the correct path to the asset
      ...
      onEnterStart(
        PointGeometry: Points<BufferGeometry, Material | Material[]>
      ) {
        console.log('ball enter start');
      },
      onEnterEnd(PointGeometry: Points<BufferGeometry, Material | Material[]>) {
    ...
    },
    {
      ...
      onAnimationFrameUpdate(
        PerfromPoint: Points<BufferGeometry, PointsMaterial>,
    ...
    },
    {
      ...
      path: new URL('../legacy-three/models/examples/cone.obj', import.meta.url)
        .href, // Use new URL() to get the correct path to the asset
      // loader: { loaderInstance: new OBJLoader() }, // Add OBJLoader instance
      onLoadComplete(Geometry: BufferGeometry) {
        Geometry.scale(scaleNum, scaleNum, scaleNum);
