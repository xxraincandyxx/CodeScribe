...
import { ParticleModelProps } from '@/legacy-three/declare/legacy-three';
  ...
  return (
    <div className={Styles.index_page}>
      ...
      <ul className={Styles.function_list}>
        ...
        <li onClick={() => MainParticle?.StopListenMouseMove()}>
          StopListenMouseMove
        </li>
        <li onClick={() => MainParticle?.AlignCameraCenter()}>
          AlignCameraCenter
        </li>
        <li onClick={() => MainParticle?.AlignCameraCenter(true)}>
